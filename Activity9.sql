...
INNER JOIN salesman2 b ON a.salesman_id=b.salesman_id;
...
SELECT a.customer_id, a.customer_name, a.city, a.grade, b.name AS "Salesman", b.city, 
a.salesman_id,b.salesman_id FROM customers a 
LEFT OUTER JOIN salesman2 b ON a.salesman_id=b.salesman_id WHERE a.grade<300 
...
-- list of customers who appointed salesman for their jobs 
-- who gets a commission from the company is more than 12%
select a.salesman_id, b.salesman_id, a.customer_name AS "Customer Name" , a.city, b.name as "Salesman" , b.commission 
from customers a
inner join salesman2 b on a.salesman_id=b.salesman_id
...
b.grade, c.name AS "Salesman", c.commission FROM orders a 
INNER JOIN customers b ON a.customer_id=b.customer_id 
INNER JOIN salesman2 c ON a.salesman_id=c.salesman_id;
